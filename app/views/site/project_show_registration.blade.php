...
@section('content')
    ...
    <section class="main-content">
        <div class="container">
            ...
            {{ Form::open(array('route' => 'reg.ps.store', 'files' => true)) }}
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="coach-info">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::text('project_name', null, array('class' => 'form-control empty iconified', 'id'  => 'project_name', 'required'  =>  'required', 'placeholder'   =>  'Project   Name')) }}
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::text('short', null, array('class' => 'form-control empty iconified', 'id'  => 'short', 'required'  =>  'required', 'placeholder'   =>  '&#xf0e0;   Short Description')) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                 ...
                                 <label for="logo"> <span>Choose Project Logo OR University Logo</span></label>
                             </div>
                         </div>
                     </div>
                ...
                {{-- <div class="row">
                    ...
                    <div class="coach-info">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                 <input type="file" name="coach_photo" id="coach_photo" class="inputfile inputfile-1"/>
                                 <label for="coach_photo"> <span>Choose Coach Photo</span></label>
                             </div>
                         </div>
                     </div>
                 ...
                 <div class="row">
                    <div class="team-member-info">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                {{ Form::text('member1_mobile', null, array('class' => 'form-control empty iconified', 'id'  => 'member1_mobile', 'required'  =>  'required', 'placeholder'   =>  '&#xf10b;   Mobile No.')) }}                             
                            </div>
                            <div class="form-group">
                             <input type="file" name="member1_photo" id="member1_photo" class="inputfile inputfile-1"/>
                             <label for="member1_photo"> <span>Upload Member1 Photo</span></label>
                         </div>

                         <div class="form-group">
                             <input type="file" name="member1_id_photo" id="member1_id_photo" class="inputfile inputfile-1"/>
                             <label for="member1_id_photo"> <span>Upload Scan Copy of Student ID</span></label>
                         </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                             <input type="file" name="member2_photo" id="member2_photo" class="inputfile inputfile-1"/>
                             <label for="member2_photo"> <span>Upload Member2 Photo</span></label>
                         </div>

                         <div class="form-group">
                             <input type="file" name="member2_id_photo" id="member2_id_photo" class="inputfile inputfile-1"/>
                             <label for="member2_id_photo"> <span>Upload Scan Copy of Student ID</span></label>
                         </div>
                     </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="file" name="member3_photo" id="member3_photo" class="inputfile inputfile-1"/>
                             <label for="member3_photo"> <span>Upload Member3 Photo</span></label>
                         </div>

                         <div class="form-group">
                             <input type="file" name="member3_id_photo" id="member3_id_photo" class="inputfile inputfile-1"/>
                             <label for="member3_id_photo"> <span>Upload Scan Copy of Student ID</span></label>
                         </div>
                     </div>
