                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control empty iconified" name="university" id="university" required="required">
                                                ...
                                                <option>Military Institute of Science and Technology</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control empty iconified" name="sc_track" id="sc_track" required="required">
                                                <option value="" selected disabled>Select Track</option>
                                                <option value="web_php">Web (PHP)</option>
                                                <option value="web_dotnet">Web (.NET)</option>
                                                <option value="web_java">Web (Java)</option>
                                                <option value="mobile_android">Mobile (Android)</option>
                                                <option value="mobile_ios">Mobile (iOS)</option>
                                                <option value="mobile_windowsphone">Mobile (Windows Phone)</option>
